...
from xenum_measurements import ACTIVE_MEASUREMENTS, CONTROL_MEASUREMENTS, HIDDEN_MEASUREMENTS, LUNA_MEASUREMENTS, MEASUREMENTS, OPTIONAL_MEASUREMENTS, SPAGCN_MEASUREMENTS, VISIBLE_MEASUREMENTS
...
from .luna import run_luna_measurements
...
def main():
    ...
    luna_rows, luna_summaries = run_luna_measurements(
        out_dir,
        args.dataset_id,
        adata,
        nodes[node_cols],
    )
    bench_rows.extend(luna_rows)
    summaries.update(luna_summaries)
    ...
    (out_dir / "summary.json").write_text(json.dumps({
        **adata.uns["xenium_clean"],
        ...
        "luna_measurements": list(LUNA_MEASUREMENTS),
